    ...
    return(
        <div>
            ...
            <div className={mainSize ? styles.smallmain : styles.bigmain }>
                ...
                <textarea style={{width: '100%',marginLeft:'250px',marginTop:'10px',height:'200px',padding: '10px',textAlign:'center'}}></textarea>
                <textarea style={{width: '100%',marginLeft:'250px',marginTop:'50px',height:'200px',padding: '10px',textAlign:'center'}}></textarea>
            </div>
        </div>
    )
}
